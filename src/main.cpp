...
#include <vector>
#include <memory>
#include "GLViewFinalRocket.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewFinalRocket > glView( Aftr::GLViewFinalRocket::New( args ) );
